...
const ChartView = defineAsyncComponent(() => import('@/modules/onesheet/components/editor/ChartView.vue'))
import { CHART_TYPES } from '@/modules/onesheet/lib/engine/charts.js'
