...
export const VIEW_TYPES = {
  list: {
    ...
    icon: 'lucide-list',
    built: true,
    body: () => import('@/modules/onespace/components/screen/bodies/ListBody.vue'),
  },
  board: {
    get label() { return __('Board') },
    icon: 'lucide-columns-3',
    built: true,
    body: () => import('@/modules/onespace/components/screen/bodies/BoardBody.vue'),
  },
  calendar: {
    get label() { return __('Calendar') },
    icon: 'lucide-calendar',
    built: true,
    body: () => import('@/modules/onespace/components/screen/bodies/CalendarBody.vue'),
  },
  dashboard: {
    get label() { return __('Dashboard') },
    icon: 'lucide-chart-column',
    built: true,
    body: () => import('@/modules/onespace/components/screen/bodies/DashboardBody.vue'),
  },
  gantt: {
    get label() { return __('Gantt') },
    icon: 'lucide-chart-no-axes-gantt',
    built: true,
    body: () => import('@/modules/onespace/components/screen/bodies/GanttBody.vue'),
  },
  grid: {
  ...
  tree: {
    ...
    built: true,
    body: () => import('@/modules/onespace/components/screen/bodies/TreeBody.vue'),
  },
}
