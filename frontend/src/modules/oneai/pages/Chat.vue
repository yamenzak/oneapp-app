...
import ChatPanel from '@/modules/oneai/components/chat/ChatPanel.vue'
import { assistant as state, assistantName, loadAssistant } from '@/modules/oneai/lib/assistant'
