...
export default defineConfig({
  ...
  test: {
    globals: true,
    include: ['src/{lib/sheets,components/sheets/editor,components/mail/reader}/**/*.test.js'],
    environment: 'node',
  },
})
