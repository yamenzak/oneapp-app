...
def list_spaces() -> list[dict]:
	...
	from oneapp.onespace.spaceview.resolve import visible
...
def find_records(
	...
	from oneapp.onespace.spaceview.records import rows
...
def count_records(
	...
	"""
	from oneapp.onespace.spaceview.records import count
...
def search_files(
	...
	from oneapp.onestorage.query import ALL
	from oneapp.onestorage.reading import listing
...
def read_document(
	...
	from oneapp.onedoc import body, text
